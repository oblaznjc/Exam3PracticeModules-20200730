...
def run_test_practice_problem3():
    ...
    tests = [st.SimpleTestCase(practice_problem3, [0, 0, 0], []),
             st.SimpleTestCase(practice_problem3, [0, 1, 0], [0])
             ]

    print()
    st.SimpleTestCase.run_tests('practice_problem3_continued', tests)
